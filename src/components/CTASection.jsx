...
export default function CtaSection() {
  return (
    <section className="relative py-16 sm:py-20 lg:py-24 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-slate-600/80 via-cyan-700/70 to-blue-800/80" />
      ...
      <div className="relative container-responsive">
        ...
        >
          ...
          >
            {/* Main card */}
            <div className="relative bg-gradient-to-r from-pink-500 via-purple-600 to-pink-500 p-8 sm:p-12 lg:p-16">
              {/* Content */}
              <div className="relative z-10">
                <motion.h2
                  className="text-white font-cartoon text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold mb-4 sm:mb-6 drop-shadow-lg"
                ...
                <motion.p
                  className="text-white/95 text-lg sm:text-xl lg:text-2xl font-medium mb-8 sm:mb-10 max-w-2xl mx-auto drop-shadow-sm"
                ...
                >
                  {/* Primary button */}
                  <motion.button
                    className="relative group bg-white text-purple-600 font-bold text-lg sm:text-xl px-8 sm:px-12 py-4 sm:py-5 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
                  ...
                  {/* Secondary button */}
                  <motion.button
                    className="group border-2 border-white text-white font-bold text-lg sm:text-xl px-8 sm:px-12 py-4 sm:py-5 rounded-2xl hover:bg-white hover:text-purple-600 transition-all duration-300 transform hover:-translate-y-1"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                  >
                    Learn More
