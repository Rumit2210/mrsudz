...
export default function CtaSection() {
  return (
    <section className="relative py-16 sm:py-20 lg:py-24 overflow-hidden">
      ...
      {/* Background overlay (kept to match your blue "bubbles" theme) */}
      <div className="absolute inset-0 bg-gradient-to-br  via-cyan-700/70 to-blue-800/80" />
      ...
      <div className="relative container-responsive">
        ...
        >
          ...
          >
            {/* Removed glowing border/outer opacity entirely */}

            {/* Main card — solid blue/cyan gradient, no border */}
            <div className="relative rounded-3xl p-8 sm:p-12 lg:p-16 shadow-2xl bg-gradient-to-r from-cyan-500 via-sky-600 to-blue-700">
              ...
              <div className="relative z-10">
                ...
                >
                  ...
                  {/* Secondary button */}
                  <motion.button
                    className="group border-2 border-white text-white font-bold text-lg sm:text-xl px-8 sm:px-12 py-4 sm:py-5 rounded-2xl hover:bg-white hover:text-sky-700 transition-all duration-300 transform hover:-translate-y-1"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                  >
                    Learn More
